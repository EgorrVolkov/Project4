...
CREATE TABLE `device` (
  ...
  CONSTRAINT `fk_device_device_model1` FOREIGN KEY (`device_model_id`) REFERENCES `device_model` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `device` VALUES (1,1,1,'12341'),(2,1,2,'12342'),(3,4,1,'12343'),(4,1,4,'12344'),(5,5,3,'12345');
...
-- Dump completed on 2018-01-20 23:32:35
